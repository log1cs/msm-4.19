...
// 20180307-second source speaker >>>
static int tas2557_SpeakerName_get(struct snd_kcontrol *pKcontrol,
	struct snd_ctl_elem_value *pValue)
{
#ifdef KCONTROL_CODEC
	struct snd_soc_component *component = snd_soc_kcontrol_component(pKcontrol);
	...
	pValue->value.integer.value[0] = pTAS2557->speaker_type;
	dev_info(pTAS2557->dev,
		"tas2557_SpeakerName_get = %d\n",
		pTAS2557->speaker_type);
...
static const struct snd_kcontrol_new tas2557_snd_controls[] = {
	...
	// 20180307-second source speaker >>>
	SOC_SINGLE_EXT("SpeakerName", SND_SOC_NOPM, 0, 0x00FF, 0,
	tas2557_SpeakerName_get, NULL),
	// // 20180307-second source speaker <<<
};

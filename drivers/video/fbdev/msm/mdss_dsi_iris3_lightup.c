...
#if defined(CONFIG_LONGCHEER_SDM660_PROJS)
static int32_t iris_parse_tx_mode(struct device_node *np, struct iris_cfg *pcfg)
{
...
#endif
#endif // CONFIG_FIH_SDM630_SDM660_PROJS
...
{
#if defined(CONFIG_FIH_SDM630_SDM660_PROJS) || !defined(IRIS3_MIPI_TEST)
	static int num;
#endif

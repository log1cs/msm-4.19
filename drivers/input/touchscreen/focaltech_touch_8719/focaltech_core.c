...
*****************************************************************************/
struct i2c_client *fts_i2c_client_8719;
struct fts_ts_data *fts_data;
struct input_dev *fts_input_dev_8719;
...
extern void touch_selftest_8719(void);
extern int selftest_result_read_8719(void);
extern void touch_tpfwver_read_8719(char *);
extern void touch_tpfwimver_read_8719(char *fw_ver);
extern void touch_fwupgrade_8719(int);
extern void touch_fwupgrade_read_8719(char *);
extern void touch_vendor_read_8719(char *);
...
/*****************************************************************************
*  Name: fts_wait_tp_to_valid_8719
...
*****************************************************************************/
int fts_wait_tp_to_valid_8719(struct i2c_client *client)
{
    int ret = 0;
    int cnt = 0;
    u8 reg_value = 0;
    ...
    do {
        ret = fts_i2c_read_reg_8719(client, FTS_REG_CHIP_ID, &reg_value);
...
static int fts_get_ic_information(struct fts_ts_data *ts_data)
{
    ...
    do {
        ret = fts_i2c_read_reg_8719(client, FTS_REG_CHIP_ID, &chip_id[0]);
        ret = fts_i2c_read_reg_8719(client, FTS_REG_CHIP_ID2, &chip_id[1]);
    ...
    if ((cnt * INTERVAL_READ_REG) >= TIMEOUT_READ_REG) {
        ...
        ret = fts_i2c_write_8719(client, id_cmd, 2);
        if (ret < 0) {
        ...
        ret = fts_i2c_read_8719(client, id_cmd, id_cmd_len, chip_id, 2);
        if ((ret < 0) || (0x0 == chip_id[0]) || (0x0 == chip_id[1])) {
...
/*****************************************************************************
*  Name: fts_tp_state_recovery_8719
*  Brief: Need execute this function when reset
*  Input:
*  Output:
*  Return:
*****************************************************************************/
void fts_tp_state_recovery_8719(struct i2c_client *client)
{
    FTS_FUNC_ENTER();
    /* wait tp stable */
    fts_wait_tp_to_valid_8719(client);
...
/*****************************************************************************
*  Name: fts_irq_disable_8719
*  Brief: disable irq
*  Input:
*  Output:
*  Return:
*****************************************************************************/
void fts_irq_disable_8719(void)
{
...
/*****************************************************************************
*  Name: fts_irq_enable_8719
*  Brief: enable irq
*  Input:
*  Output:
*  Return:
*****************************************************************************/
void fts_irq_enable_8719(void)
{
...
static int fts_read_touchdata(struct fts_ts_data *data)
{
    ...
    ret = fts_i2c_read_8719(data->client, buf, 1, buf, data->pnt_buf_size);
    if (ret < 0) {
...
static int fts_parse_dt(struct device *dev, struct fts_ts_platform_data *pdata)
{
    ...
    ret = of_property_read_string(np, "focaltech,device-model", &device_model);

    if (0 == ret)
    {
          fw_app_bin_8719 = "TP_Firmware_FT8719.bin";
          tp_ini_8719="8719.ini";
    }
    else
    {
...
static int fts_ts_probe(struct i2c_client *client, const struct i2c_device_id *id)
{
...
#if FTS_APK_NODE_EN
    ret = fts_create_apk_debug_channel_8719(ts_data);
    if (ret) {
    ...
    ret = fts_create_sysfs_8719(client);
    if (ret) {
    ...
    ret = fts_ex_mode_init_8719(client);
    if (ret) {
    ...
    touch_cb.touch_selftest = touch_selftest_8719;
    touch_cb.touch_selftest_result = selftest_result_read_8719;
    touch_cb.touch_tpfwver_read = touch_tpfwver_read_8719;
    touch_cb.touch_tpfwimver_read = touch_tpfwimver_read_8719;
...
#if FTS_APK_NODE_EN
    fts_release_apk_debug_channel_8719(ts_data);
#endif

#if FTS_SYSFS_NODE_EN
    fts_remove_sysfs_8719(client);
#endif

    fts_ex_mode_exit_8719(client);

...
#define HIMAX_DRIVER_VER "1.2.2.81_ABCD1234_01"

#define FLASH_DUMP_FILE "/sdcard/HX_Flash_Dump.bin"

#if defined(CONFIG_TOUCHSCREEN_HIMAX_DEBUG)
	#define HX_TP_PROC_2T2R
	#define HX_TP_SELF_TEST_DRIVER /*if enable, selftest works in driver*//*add by shenwenbin for hx83112a TP selftest 20190429*/
#endif
...
#define HX_CONTAINER_SPEED_UP 	/*Independent threads run the  function resume */

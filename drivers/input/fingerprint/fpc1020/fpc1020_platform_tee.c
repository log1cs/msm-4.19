...
/* Black Box */
#define BBOX_FPC1020_PROBE_FAIL do {printk("BBox;%s: Probe fail, LINE=%d\n", __func__, __LINE__); printk("BBox::UEC;39::0\n");} while (0);
#define BBOX_FPC1020_RESET_FAIL do {printk("BBox;%s: Reset chip, LINE=%d\n", __func__, __LINE__); printk("BBox::UEC;39::1\n");} while (0);
#define BBOX_FPC1020_RESET_CHIP_FAIL do {printk("BBox;%s: Reset chip fail, LINE=%d\n", __func__, __LINE__); printk("BBox::UEC;39::2\n");} while (0);
#define BBOX_FPC1020_RESET_CHIP_HOLD_LOW_FAIL do {printk("BBox;%s: Reset chip hold low fail, LINE=%d\n", __func__, __LINE__); printk("BBox::UEC;39::3\n");} while (0);
